...
class ResNetTrainer():
  def __init__(self, dataset, model, arch_tag, criterion = nn.CrossEntropyLoss(), device = 'cuda', lr = 0.1, batch_size = 128):
  ...
  def _init_opt(self):
    ...
    # self.scheduler = torch.optim.lr_scheduler.MultiStepLR(self.optimizer, milestones=[60, 120, 160], gamma=0.1)
